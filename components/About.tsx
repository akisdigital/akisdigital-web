export default function About() {
  return (
    <section id="hakkimizda" className="py-24 px-4 sm:px-6 border-t border-white/[0.06]">
      <div className="max-w-3xl mx-auto">
        <div className="text-center mb-14">
          <h2 className="text-3xl sm:text-4xl font-bold text-white mb-4">Hakkımızda</h2>
          <div className="w-12 h-0.5 bg-gradient-to-r from-violet-500 to-purple-600 mx-auto rounded-full" />
        </div>
        ...
        <div className="space-y-7 text-zinc-400 leading-relaxed text-sm sm:text-base">
          ...
          <p>
            Mevcut altyapınıza entegre olan çözümlerimiz, sıfırdan bir sistem kurma ihtiyacı
            duymadan operasyonel dönüşümünüzü başlatmanızı sağlar. Türk lojistik sektörünün
            dinamiklerini derinden anlıyor, her müşteriye ihtiyacına özel yaklaşımlar sunuyoruz.
          </p>
        </div>
      </div>
    </section>
